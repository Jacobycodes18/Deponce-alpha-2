...
?>
   ...
   <main class="main-row">
	...
	<div class="vc_icon_element-inner vc_icon_element-color-custom vc_icon_element-have-style-inner vc_icon_element-size-lg vc_icon_element-style-rounded-outline vc_icon_element-outline vc_icon_element-background-color-custom" style="border-color:#c48f56">
		<span class="vc_icon_element-icon multimedia-icon-envelope" style="color: !important"></span></div>
</div>

	<div class="wpb_text_column wpb_content_element " >
		<div class="wpb_wrapper">
			<p style="text-align: center;"><span style="font-weight: 300;">Contact@deponce.io</span></p>
	...
	<div class="vc_icon_element-inner vc_icon_element-color-custom vc_icon_element-have-style-inner vc_icon_element-size-lg vc_icon_element-style-rounded-outline vc_icon_element-outline vc_icon_element-background-color-custom" style="border-color:#c48f56">
		<span class="vc_icon_element-icon multimedia-icon-placeholder" style="color: !important"></span></div>
</div>

	<div class="wpb_text_column wpb_content_element " >
		<div class="wpb_wrapper">
			<p style="text-align: center;"><span style="font-weight: 300;">Fayettville and Greater North West Arkansas areas.</span></p>
...
</div></div></div></div><div class="vc_row wpb_row vc_row-fluid"><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner "><div class="wpb_wrapper"><div class="heading-decor-s tac"><h4 style="text-align: center" class="h vc_custom_heading" ><div>Get in Touch Today</div></h4></div>
	<div class="wpb_text_column wpb_content_element " >
		<div class="wpb_wrapper">
...
<input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f760-p753-o1" />
<input type="hidden" name="_wpcf7_container_post" value="753" />
</div>
<div class="tac" style="max-width: 350px; margin: 0 auto;">
<span class="wpcf7-form-control-wrap name-p"><input type="text" name="name" value="<?php if(isset($_POST['name'])){echo $_POST['name'];}?>" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required style3" aria-required="true" aria-invalid="false" placeholder="Enter your name" /></span><br />
...
<span class="wpcf7-form-control-wrap text"><textarea name="message" cols="40" rows="4" value="" class="wpcf7-form-control wpcf7-textarea wpcf7-validates-as-required style3" aria-required="true" aria-invalid="false" placeholder="Enter your Message"><?php if(isset($_POST['message'])){echo $_POST['message'];}?></textarea></span><br />
...
<!--        <div class="vc_row wpb_row vc_row-fluid"><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner vc_custom_1505914410329"><div class="wpb_wrapper"><div class="map" id="map-5af09de078cb7" style="width: 100%; height: 345px;"></div></div></div></div></div>-->
